...
std::map<std::string, maker_std_msgs_string *, std::less<std::string> > factory_std_msgs_string;
...
// Create a Std_msgs_string class that subclasses the generic rclcpp::Node base class.
// The main function below will instantiate the class as a ROS node.
class Std_msgs_string : public rclcpp::Node
{
public:
  explicit Std_msgs_string(const std::string & sub_topic, const std::string & pub_topic)
  : Node("std_msgs_string")
  {
    ...
    auto callback =
      [this](std_msgs::msg::String::SharedPtr msg) -> void
      {
        ...
        if (factory_std_msgs_string.size() > 0)
        {
          // remove const from callback parameter
          baseclass_std_msgs_string *plugin = factory_std_msgs_string["class_std_msgs_string"]();
    ...
    sub_ = create_subscription<std_msgs::msg::String>(sub_topic, 10, callback);
    rclcpp::QoS qos(rclcpp::KeepLast(7));
    pub_ = this->create_publisher<std_msgs::msg::String>(pub_topic, qos);
  }
...
int main(int argc, char * argv[])
{
  ...
  // Create a node.
  auto node = std::make_shared<Std_msgs_string>(sub_topic, pub_topic);
